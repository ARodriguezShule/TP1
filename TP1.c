...
// c) Convertir una cadena de caracteres a la misma cadena con todos sus caracteres
// en mayúscula.
...
// f) Modificar la cadena dada con la inserción de un carácter dado en una posición
// determinada.
